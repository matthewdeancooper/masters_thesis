...
\todo{To assess properly doesn't need to be a project unto itself, just a figure with a PDD, and a note regarding what a change in patient surface by the largest amount you found in your model corresponds to as a change in dose at 10 cm depth in the patient.}
