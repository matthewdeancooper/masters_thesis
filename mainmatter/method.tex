...
\todo{Just one decimal point here}
of all output pixel in the data, with 0.081\% and 0.021\%
\todo{probably just one sig fig for these within the text, keep the precision in the table though.\ldots}
...
\todo{\ldots and to combat over-fitting via regularisation.}
...
We
\todo{Have you been asked to use personal pronouns? You use them throughout and they seem odd to me in this kind of report\ldots}
...
\todo{In the section above you shortened this to sDSC, I don't mind which one you chose, just be consistent.}
...
\todo{I would recommend using textrm command here -- $\textrm{w. soft DSC} = \frac{2 \, (W \cdot I + \epsilon)}{W \cdot U + \epsilon}$}
...
\todo{Way too many sig figs here, 2 sig figs, no more.}
for the rectum.